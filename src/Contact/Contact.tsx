  ...
  return (
    <div className="contact-root">
      ...
      <div className="contact-socials">
        <a href="https://linkedin.com/in/shlokthakkar" target="_blank" rel="noopener noreferrer" className="contact-social-link">
        ...
        <a href="https://github.com/shlokthakkar" target="_blank" rel="noopener noreferrer" className="contact-social-link">
